                        ...
                        if (body) {
                            ...
                            if (isTracked) {
                                ...
                                if (!rightFootRaised) {
                                    ...
                                    if (rightAnkle.TrackingState == TrackingState_Tracked && fabs(rightAnkle.Position.Z - leftAnkle.Position.Z) > 0.2f) {
                                ...
                                if (rightFootRaised && (fabs(rightAnkle.Position.Z - leftAnkle.Position.Z) < 0.2f || fabs(rightAnkle.Position.Y) < 0.1f)) {
